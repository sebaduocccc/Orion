...
const ProfileFeed = ( {userId, username} ) => { // el ( { userId }) para que cuando se tenga que montar le pases el id de usuario
    ...
    const cargarPosts = async (numeroPagina) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/posts/feed/${userId}?page=${numeroPagina}&size=10`, {
                headers: {
    ...
    return(
        ...
        <div className="container mt-4">
            ...
            <h5 className="text-muted mb-3">Últimas publicaciones de {username}</h5>
