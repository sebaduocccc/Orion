...
class ControllerComentarioTest {
    ...
    @Test
    @DisplayName("comentar: 201 created con userId del header")
    void comentar_ok() {
        ...
        ResponseEntity<ResponseComentario> resp = controller.comentar(10L, req, USER_ID);
    ...
    @Test
    @DisplayName("actualizar: 200 ok con userId del header")
    void actualizar_ok() {
        ...
        ResponseEntity<ResponseComentario> resp = controller.actualizar(1L, req, USER_ID);
