...
public class ServiceComentario {
    ...
    @Transactional
    public ResponseComentario guardar(Long postId, RequestComentario dto, Long userId) {
        Comentario comentario = mapper.aEntidad(dto, postId, userId);
    ...
    @Transactional
    public ResponseComentario actualizar(Long id, RequestComentario dto, Long userId) {
